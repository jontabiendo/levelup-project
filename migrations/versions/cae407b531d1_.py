...
Revision ID: cae407b531d1
Revises: 
Create Date: 2023-07-11 15:49:28.300392
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['teams'], ['teams.id'], ),
    sa.PrimaryKeyConstraint('members', 'teams')
    )
